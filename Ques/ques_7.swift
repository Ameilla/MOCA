...
class ques_7: UIViewController {
    ...
    @IBAction func optionButtonTapped(_ sender: UIButton) {        // Deselect all buttons
    ...
    @IBAction func submitButtonTapped(_ sender: UIButton) {
        guard let selectedOption = selectedOption, let correctAnswer = self.QuestionTrial1?.questions[6].answer else {
        ...
        // Set the img property before attempting to convert it to data
        ...
        let vc = storyBoard.instantiateViewController(withIdentifier: "ques_8") as! ques_8
        vc.id = id
        vc.task1 = task1
        vc.task2 = task2
        vc.task3 = task3
